    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/admin/message-inbox')}}"><i class="fa fa-link"></i> <span>Inbox</span></a></li>
            <li><a href="{{url('/admin/outbox')}}"><i class="fa fa-link"></i> <span>Sent Messages</span></a></li>
            <li><a href="{{url('/admin/create-message')}}"><i class="fa fa-link"></i> <span>Compose</span></a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/admin/students')}}"><i class="fa fa-link"></i> <span>Add Student</span></a></li>
            <li><a href="#"><i class="fa fa-link"></i> <span>Add User</span></a></li>
            <li><a href="#"><i class="fa fa-link"></i> <span>List Users</span></a></li>
          </ul>
        </li>
