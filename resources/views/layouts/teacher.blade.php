    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/teacher/message-inbox')}}"><i class="fa fa-link"></i> <span>Inbox</span></a></li>
            <li><a href="{{url('/teacher/outbox')}}"><i class="fa fa-link"></i> <span>Sent Messages</span></a></li>
            <li><a href="{{url('/teacher/create-message')}}"><i class="fa fa-link"></i> <span>Compose</span></a></li>
          </ul>
        </li>
